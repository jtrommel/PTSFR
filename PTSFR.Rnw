...
\begin{itemize}
  ...
  \item trend: linear with slope=0 or slope=$\frac{5\sigma}{N}$
  \item seasonality 1: sine with amplitude=0 or $2\sigma$, period=$\frac{N}{10}$, phase=0
  \item seasonality 2: sine with amplitude=0 or $\sigma$, period=$\frac{N}{40}$, phase=$\frac{\pi}{3}$
...
\begin{figure}
\includegraphics[width=1\textwidth]{PTSFR-constructs}
