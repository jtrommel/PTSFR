...
<<>>=
Amtrak.data$Season <- rep(c("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"), length.out = nrow(Amtrak.data))
Amtrak.seas.lm <- lm(Ridership[1:123] ~ Season[1:123], data = Amtrak.data)
summary(Amtrak.seas.lm)
@
